(function($) {
	...
	$('#submit-home').bind('click', function(event){
		event.preventDefault();
		if(!hasDefaults('contact')) { $('#form-home').submit(); }
	...
	function validateContact() {
		if(!$('#form-home').valid()) { return false; console.log('Validation error'); }
